...
try:
    ...
    print("INFO: Clés API Gemini et Birdeye chargées.")
...
def analyze():
    ...
    if not dex_data:
        ...
        # On cherche une paire pour le graphique
        ...
        if not pair_address and dex_data.get('pairs'):
            pair_address = dex_data['pairs'][0]['address'] # On prend la première paire si Raydium n'est pas trouvé
